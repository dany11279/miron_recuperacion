...
<div class="container">
    ...
    <div class="row justify-content-center">
        <form action="/miron_recuperacion/controladores/problemas_reportados/modificar.php" method="POST" class="col-lg-8 border bg-light p-3">
            <input type="hidden" name="pro_id" id="pro_id" value="<?= $problemas_problemas_reportados[0]['PRO_ID'] ?>">
            <div class="row mb-3">
                <div class="col">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <texproblemas_reportados name="pro_descripcion" id="pro_descripcion" class="form-control" rows="4" required><?= $problemas_problemas_reportados[0]['PRO_DESCRIPCION'] ?></texproblemas_reportados>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label for="fecha_asignacion">Fecha de Asignación</label>
                    <input type="date" name="pro_fecha" id="pro_fecha" value="<?= $problemas_problemas_reportados[0]['PRO_FECHA'] ?>" class="form-control" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
