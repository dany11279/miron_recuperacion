...
<div class="container">
    ...
    <div class="row justify-content-center">
        <form action="/miron_recuperacion/controladores/problemas_reportados/modificar.php" method="POST" class="col-lg-8 border bg-light p-3">
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="pro$problemas_reportados">problemas reportados</label>
                    <texpro$problemas_reportados name="pro_descripcion" id="pro_descripcion" class="form-control" rows="4" required><?= $problemas_reportados[0]['PRO_DESCRIPCION'] ?></texpro$problemas_reportados>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
